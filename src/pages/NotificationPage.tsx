...
import {
  Bell, CheckCheck, MessageSquare, CreditCard, Star, Info, CheckCircle,
  XCircle, Clock, ChevronLeft, ChevronRight, Filter, Mail,
  BookOpen, Briefcase, Users, AlertTriangle, Award, FileText,
  DollarSign, ArrowDownCircle, ArrowUpCircle, Shield, Gavel,
  Send, Check, Ban, Eye, Zap, Heart, MessageCircle,
  GraduationCap, FileCheck, FileX, RefreshCw, Wrench,
  TrendingUp, BadgeCheck, UserPlus, UserX, Clock3, Scale,
  Lock, Megaphone, AlertCircle, BellRing, CalendarCheck,
  UserCheck, Handshake, PenLine, Trash2, Ban as BanIcon
} from 'lucide-react';
...
const getIcon = (type: string) => {
  switch (type) {
    // Social / Community
    case 'LIKE': return <Heart size={24} />;
    case 'COMMENT': return <MessageSquare size={24} />;
    case 'PRECHAT_MESSAGE': return <MessageCircle size={24} />;
    case 'RECRUITMENT_MESSAGE': return <Send size={24} />;

    // Premium / Subscription
    case 'PREMIUM_PURCHASE': return <Star size={24} />;
    case 'PREMIUM_EXPIRATION': return <Clock3 size={24} />;
    case 'PREMIUM_CANCEL': return <XCircle size={24} />;

    // Wallet / Payment
    case 'WALLET_DEPOSIT': return <ArrowDownCircle size={24} />;
    case 'COIN_PURCHASE': return <DollarSign size={24} />;
    case 'WITHDRAWAL_APPROVED': return <CheckCircle size={24} />;
    case 'WITHDRAWAL_REJECTED': return <XCircle size={24} />;

    // Mentor Booking
    case 'BOOKING_CREATED': return <CalendarCheck size={24} />;
    case 'BOOKING_CONFIRMED': return <CheckCircle size={24} />;
    case 'BOOKING_REJECTED': return <XCircle size={24} />;
    case 'BOOKING_REMINDER': return <BellRing size={24} />;
    case 'BOOKING_COMPLETED': return <Check size={24} />;
    case 'BOOKING_CANCELLED': return <BanIcon size={24} />;
    case 'BOOKING_REFUND': return <ArrowUpCircle size={24} />;
    case 'BOOKING_STARTED': return <Zap size={24} />;
    case 'BOOKING_MENTOR_COMPLETED': return <Check size={24} />;
    case 'MENTOR_REVIEW_RECEIVED': return <Star size={24} />;
    case 'MENTOR_LEVEL_UP': return <TrendingUp size={24} />;
    case 'MENTOR_BADGE_AWARDED': return <BadgeCheck size={24} />;

    // Course / Assignment
    case 'TASK_DEADLINE': return <Clock size={24} />;
    case 'TASK_OVERDUE': return <AlertTriangle size={24} />;
    case 'TASK_REVIEW': return <FileCheck size={24} />;
    case 'ASSIGNMENT_SUBMITTED': return <FileCheck size={24} />;
    case 'ASSIGNMENT_GRADED': return <GraduationCap size={24} />;
    case 'ASSIGNMENT_LATE': return <FileX size={24} />;
    case 'COURSE_REJECTED': return <XCircle size={24} />;
    case 'COURSE_SUSPENDED': return <BanIcon size={24} />;
    case 'COURSE_RESTORED': return <RefreshCw size={24} />;

    // Escrow / Business
    case 'ESCROW_FUNDED': return <Shield size={24} />;
    case 'ESCROW_RELEASED': return <DollarSign size={24} />;
    case 'ESCROW_REFUNDED': return <ArrowUpCircle size={24} />;
    case 'DISPUTE_OPENED': return <AlertCircle size={24} />;
    case 'DISPUTE_RESOLVED': return <Scale size={24} />;

    // Short-term Jobs
    case 'JOB_APPROVED': return <CheckCircle size={24} />;
    case 'JOB_REJECTED': return <XCircle size={24} />;
    case 'JOB_DELETED': return <Trash2 size={24} />;
    case 'JOB_BANNED': return <BanIcon size={24} />;
    case 'JOB_UNBANNED': return <RefreshCw size={24} />;
    case 'SHORT_TERM_APPLICATION_SUBMITTED': return <UserPlus size={24} />;
    case 'SHORT_TERM_APPLICATION_ACCEPTED': return <UserCheck size={24} />;
    case 'SHORT_TERM_APPLICATION_REJECTED': return <UserX size={24} />;
    case 'SHORT_TERM_WORK_SUBMITTED': return <FileCheck size={24} />;
    case 'SHORT_TERM_WORK_APPROVED': return <CheckCircle size={24} />;
    case 'FULLTIME_APPLICATION_REVIEWED': return <Eye size={24} />;
    case 'FULLTIME_APPLICATION_ACCEPTED': return <UserCheck size={24} />;
    case 'FULLTIME_APPLICATION_REJECTED': return <UserX size={24} />;

    // Admin / Escalation
    case 'WORKER_CANCELLATION_REQUESTED': return <AlertTriangle size={24} />;
    case 'WORKER_AUTO_CANCELLED': return <XCircle size={24} />;
    case 'WORKER_AUTO_APPROVED': return <CheckCircle size={24} />;
    case 'RECRUITER_AUTO_APPROVED_WARNING': return <AlertCircle size={24} />;
    case 'ADMIN_DISPUTE_ESCALATED': return <Shield size={24} />;
    case 'DISPUTE_ELIGIBILITY_UNLOCKED': return <Lock size={24} />;
    case 'REVIEW_WINDOW_EXPIRING': return <Clock size={24} />;

    // System
    case 'WELCOME': return <UserPlus size={24} />;
    case 'SYSTEM': return <Info size={24} />;
    case 'WARNING': return <AlertTriangle size={24} />;
    case 'VIOLATION_REPORT': return <Megaphone size={24} />;

    // Contract / Signing
    case 'CONTRACT_SENT_FOR_SIGNATURE': return <Send size={24} />;
    case 'CONTRACT_SIGNED': return <Handshake size={24} />;
    case 'CONTRACT_REJECTED': return <XCircle size={24} />;
    case 'CONTRACT_CANCELLED': return <BanIcon size={24} />;
    case 'CONTRACT_EXPIRED': return <Clock size={24} />;
...
const getIconColor = (type: string): string => {
  switch (type) {
    case 'LIKE': return 'var(--notif-like)';
    case 'COMMENT':
    case 'PRECHAT_MESSAGE':
    case 'RECRUITMENT_MESSAGE': return 'var(--notif-comment)';
    case 'PREMIUM_PURCHASE':
    case 'PREMIUM_EXPIRATION':
    case 'PREMIUM_CANCEL': return 'var(--notif-premium)';
    case 'WALLET_DEPOSIT':
    case 'COIN_PURCHASE':
    ...
    case 'ESCROW_REFUNDED': return 'var(--notif-wallet)';
    ...
    case 'MENTOR_REVIEW_RECEIVED': return 'var(--notif-booking)';
    case 'MENTOR_LEVEL_UP':
    case 'MENTOR_BADGE_AWARDED': return 'var(--notif-mentor)';
    case 'TASK_DEADLINE':
    case 'TASK_OVERDUE':
    case 'TASK_REVIEW':
    ...
    case 'COURSE_RESTORED': return 'var(--notif-course)';
    case 'DISPUTE_OPENED':
    case 'DISPUTE_RESOLVED':
    case 'ADMIN_DISPUTE_ESCALATED':
    case 'DISPUTE_ELIGIBILITY_UNLOCKED': return 'var(--notif-dispute)';
    case 'JOB_APPROVED':
    case 'JOB_REJECTED':
    case 'JOB_DELETED':
    case 'JOB_BANNED':
    ...
    case 'REVIEW_WINDOW_EXPIRING': return 'var(--notif-job)';
    case 'CONTRACT_SENT_FOR_SIGNATURE':
    case 'CONTRACT_SIGNED':
    case 'CONTRACT_REJECTED':
    case 'CONTRACT_CANCELLED':
    case 'CONTRACT_EXPIRED': return 'var(--notif-contract)';
    case 'WELCOME': return 'var(--notif-primary)';
    case 'SYSTEM': return 'var(--notif-secondary)';
    case 'WARNING': return 'var(--notif-warning)';
    case 'VIOLATION_REPORT': return 'var(--notif-error)';
    default: return 'var(--notif-primary)';
  }
};
...
const getTypeCategory = (type: string): string => {
  const categories: Record<string, string[]> = {
    ...
    wallet: ['WALLET_DEPOSIT', 'COIN_PURCHASE', 'WITHDRAWAL_APPROVED', 'WITHDRAWAL_REJECTED'],
    booking: ['BOOKING_CREATED', 'BOOKING_CONFIRMED', 'BOOKING_REJECTED', 'BOOKING_REMINDER',
      'BOOKING_COMPLETED', 'BOOKING_CANCELLED', 'BOOKING_REFUND', 'BOOKING_STARTED',
      'BOOKING_MENTOR_COMPLETED', 'MENTOR_REVIEW_RECEIVED'],
    mentor: ['MENTOR_LEVEL_UP', 'MENTOR_BADGE_AWARDED'],
    course: ['TASK_DEADLINE', 'TASK_OVERDUE', 'TASK_REVIEW', 'ASSIGNMENT_SUBMITTED',
      'ASSIGNMENT_GRADED', 'ASSIGNMENT_LATE', 'COURSE_REJECTED', 'COURSE_SUSPENDED', 'COURSE_RESTORED'],
    escrow: ['ESCROW_FUNDED', 'ESCROW_RELEASED', 'ESCROW_REFUNDED', 'REVIEW_WINDOW_EXPIRING'],
    dispute: ['DISPUTE_OPENED', 'DISPUTE_RESOLVED', 'ADMIN_DISPUTE_ESCALATED', 'DISPUTE_ELIGIBILITY_UNLOCKED'],
    job: ['JOB_APPROVED', 'JOB_REJECTED', 'JOB_DELETED', 'JOB_BANNED', 'JOB_UNBANNED',
      'SHORT_TERM_APPLICATION_SUBMITTED', 'SHORT_TERM_APPLICATION_ACCEPTED',
      'SHORT_TERM_APPLICATION_REJECTED', 'SHORT_TERM_WORK_SUBMITTED',
      'SHORT_TERM_WORK_APPROVED', 'FULLTIME_APPLICATION_REVIEWED',
      'FULLTIME_APPLICATION_ACCEPTED', 'FULLTIME_APPLICATION_REJECTED',
      'WORKER_CANCELLATION_REQUESTED', 'WORKER_AUTO_CANCELLED',
      'WORKER_AUTO_APPROVED', 'RECRUITER_AUTO_APPROVED_WARNING'],
    contract: ['CONTRACT_SENT_FOR_SIGNATURE', 'CONTRACT_SIGNED', 'CONTRACT_REJECTED',
...
const buildContractTarget = (relatedId: string, user: any, type: string): NotificationTarget => {
  if (!relatedId) {
  ...
  switch (type) {
    ...
    case 'DISPUTE_RESOLVED': {
      ...
      const looksLikeShortTermDispute =
        normalizedMessage.includes('job') || normalizedMessage.includes('công việc');
...
const getTypeDescription = (type: string, message: string): string => {
  const descriptions: Record<string, string> = {
    ...
    SHORT_TERM_WORK_APPROVED: 'Công việc đã được duyệt. Bạn sẽ nhận được thanh toán.',
    ...
    FULLTIME_APPLICATION_REJECTED: 'Rất tiếc, đơn ứng tuyển không được chấp nhận.',
...
const getTypeBannerColor = (type: string): string => {
  switch (type) {
    case 'LIKE': return 'linear-gradient(135deg, #ff6b9d, #c44569)';
    case 'COMMENT':
    case 'PRECHAT_MESSAGE':
    case 'RECRUITMENT_MESSAGE': return 'linear-gradient(135deg, #4facfe, #00f2fe)';
    case 'PREMIUM_PURCHASE':
    case 'PREMIUM_EXPIRATION':
    case 'PREMIUM_CANCEL': return 'linear-gradient(135deg, #f093fb, #f5576c)';
    case 'WALLET_DEPOSIT':
    case 'COIN_PURCHASE':
    case 'WITHDRAWAL_APPROVED':
    case 'ESCROW_FUNDED':
    case 'ESCROW_RELEASED': return 'linear-gradient(135deg, #10b981, #059669)';
    case 'WITHDRAWAL_REJECTED':
    case 'ESCROW_REFUNDED': return 'linear-gradient(135deg, #f59e0b, #d97706)';
    case 'BOOKING_CREATED':
    case 'BOOKING_CONFIRMED':
    case 'BOOKING_STARTED':
    case 'BOOKING_COMPLETED':
    case 'BOOKING_MENTOR_COMPLETED': return 'linear-gradient(135deg, #6366f1, #8b5cf6)';
    case 'BOOKING_REJECTED':
    case 'BOOKING_CANCELLED': return 'linear-gradient(135deg, #ef4444, #dc2626)';
    case 'BOOKING_REMINDER': return 'linear-gradient(135deg, #f59e0b, #d97706)';
    case 'BOOKING_REFUND': return 'linear-gradient(135deg, #10b981, #059669)';
    case 'MENTOR_REVIEW_RECEIVED':
    case 'MENTOR_LEVEL_UP':
    case 'MENTOR_BADGE_AWARDED': return 'linear-gradient(135deg, #f59e0b, #eab308)';
    case 'TASK_DEADLINE':
    case 'TASK_REVIEW':
    case 'ASSIGNMENT_SUBMITTED':
    case 'ASSIGNMENT_GRADED': return 'linear-gradient(135deg, #6366f1, #8b5cf6)';
    case 'TASK_OVERDUE':
    case 'ASSIGNMENT_LATE':
    case 'COURSE_REJECTED':
    case 'COURSE_SUSPENDED': return 'linear-gradient(135deg, #ef4444, #dc2626)';
    case 'COURSE_RESTORED': return 'linear-gradient(135deg, #10b981, #059669)';
    case 'DISPUTE_OPENED': return 'linear-gradient(135deg, #ef4444, #b91c1c)';
    case 'DISPUTE_RESOLVED': return 'linear-gradient(135deg, #10b981, #059669)';
    case 'ADMIN_DISPUTE_ESCALATED': return 'linear-gradient(135deg, #dc2626, #b91c1c)';
    case 'DISPUTE_ELIGIBILITY_UNLOCKED': return 'linear-gradient(135deg, #6366f1, #4f46e5)';
    case 'JOB_APPROVED':
    case 'SHORT_TERM_WORK_APPROVED':
    case 'FULLTIME_APPLICATION_ACCEPTED':
    case 'WORKER_AUTO_APPROVED': return 'linear-gradient(135deg, #10b981, #059669)';
    case 'JOB_REJECTED':
    case 'SHORT_TERM_APPLICATION_REJECTED':
    case 'FULLTIME_APPLICATION_REJECTED':
    case 'WORKER_AUTO_CANCELLED': return 'linear-gradient(135deg, #ef4444, #dc2626)';
    case 'JOB_DELETED':
    case 'JOB_BANNED': return 'linear-gradient(135deg, #6b7280, #4b5563)';
    case 'JOB_UNBANNED': return 'linear-gradient(135deg, #10b981, #059669)';
    case 'SHORT_TERM_APPLICATION_SUBMITTED':
    case 'FULLTIME_APPLICATION_REVIEWED': return 'linear-gradient(135deg, #6366f1, #8b5cf6)';
    case 'SHORT_TERM_APPLICATION_ACCEPTED': return 'linear-gradient(135deg, #10b981, #059669)';
    case 'SHORT_TERM_WORK_SUBMITTED': return 'linear-gradient(135deg, #f59e0b, #d97706)';
    case 'WORKER_CANCELLATION_REQUESTED':
    case 'RECRUITER_AUTO_APPROVED_WARNING':
    case 'REVIEW_WINDOW_EXPIRING': return 'linear-gradient(135deg, #f59e0b, #d97706)';
    case 'CONTRACT_SENT_FOR_SIGNATURE':
    case 'CONTRACT_SIGNED': return 'linear-gradient(135deg, #6366f1, #8b5cf6)';
    case 'CONTRACT_REJECTED':
    case 'CONTRACT_CANCELLED':
    case 'CONTRACT_EXPIRED': return 'linear-gradient(135deg, #ef4444, #dc2626)';
    case 'WELCOME': return 'linear-gradient(135deg, #6366f1, #8b5cf6)';
    case 'SYSTEM': return 'linear-gradient(135deg, #3b82f6, #2563eb)';
    case 'WARNING': return 'linear-gradient(135deg, #f59e0b, #d97706)';
    case 'VIOLATION_REPORT': return 'linear-gradient(135deg, #ef4444, #dc2626)';
...
const NotificationPage: React.FC = () => {
  ...
  const getActionLabel = (type: string, currentUser: any): string => {
    ...
    switch (type) {
      case 'CONTRACT_SENT_FOR_SIGNATURE': return 'Ký ngay';
      case 'CONTRACT_SIGNED': return 'Xem hợp đồng';
      case 'CONTRACT_REJECTED':
      case 'CONTRACT_CANCELLED':
      case 'CONTRACT_EXPIRED': return 'Xem chi tiết';
      case 'BOOKING_CREATED':
      case 'BOOKING_CONFIRMED':
      case 'BOOKING_REMINDER': return 'Xem booking';
      case 'BOOKING_REJECTED':
      case 'BOOKING_CANCELLED': return 'Xem chi tiết';
      case 'PREMIUM_PURCHASE': return 'Kiểm tra Premium';
      case 'PREMIUM_EXPIRATION': return 'Gia hạn ngay';
      case 'WALLET_DEPOSIT':
      case 'COIN_PURCHASE': return 'Xem ví';
      case 'WITHDRAWAL_APPROVED':
      case 'WITHDRAWAL_REJECTED': return 'Xem ví';
      case 'ESCROW_FUNDED':
      case 'ESCROW_RELEASED':
      case 'ESCROW_REFUNDED': return 'Xem ví';
      case 'DISPUTE_OPENED':
      case 'DISPUTE_RESOLVED': return 'Xem khiếu nại';
      case 'SHORT_TERM_APPLICATION_ACCEPTED':
      case 'FULLTIME_APPLICATION_ACCEPTED': return 'Xem hợp đồng';
      case 'SHORT_TERM_WORK_APPROVED': return 'Xem thanh toán';
      case 'WELCOME': return 'Khám phá ngay';
      case 'VIOLATION_REPORT': return 'Xem báo cáo';
      case 'MENTOR_LEVEL_UP':
      case 'MENTOR_BADGE_AWARDED': return 'Xem thành tích';
      case 'COURSE_REJECTED':
      case 'COURSE_SUSPENDED':
      case 'COURSE_RESTORED': return 'Xem khóa học';
                ...
                <div className="notif-content">
                  ...
                  <p className="notif-message">
                    {notification.senderName && (
                      <span style={{ fontWeight: 'bold', color: getIconColor(notification.type), marginRight: '6px' }}>
                        {notification.senderName}
                      </span>
                    )}
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{ background: getTypeBannerColor(selectedNotification.type) }}
              >
                ...
                <div className="modal-banner-info">
                  <span className="modal-type-badge">{getTypeLabel(selectedNotification.type)}</span>
                  <h2 className="modal-title" style={{ color: 'white', textShadow: '0 2px 8px rgba(0,0,0,0.3)' }}>
              ...
              <div className="modal-content-wrapper">
                  ...
                  <div className="modal-sender-info">
                    ...
                    >
                      {selectedNotification.senderAvatar ? (
                        ...
                        <Users size={20} style={{ color: getIconColor(selectedNotification.type) }} />
                      )}
                    </div>
                    <span className="modal-sender-name">{selectedNotification.senderName}</span>
                  </div>
                )}

                {/* Message */}
                <div className="modal-message-box" style={{
                  ...
                  <p className="modal-message" style={{ color: 'var(--notif-text)' }}>
                    {getTypeDescription(selectedNotification.type, selectedNotification.message)}
                  </p>
                  {selectedNotification.message && (
                    <p className="modal-message-raw" style={{
                ...
                {(selectedNotification.type === 'CONTRACT_SENT_FOR_SIGNATURE') && (
                  <div className="modal-contract-cta">
                    <PenLine size={20} />
                    <span>Hợp đồng đang chờ bạn ký. Vui lòng kiểm tra nội dung và ký trong 72 giờ.</span>
                  </div>
                )}
                {(selectedNotification.type === 'CONTRACT_SIGNED') && (
                  <div className="modal-contract-cta" style={{ background: 'rgba(16, 185, 129, 0.1)', borderColor: 'rgba(16, 185, 129, 0.3)' }}>
                    <CheckCircle size={20} style={{ color: '#10b981' }} />
                    <span>Hợp đồng đã được cả hai bên ký và có hiệu lực pháp luật.</span>
                  </div>
                )}
                {(selectedNotification.type === 'CONTRACT_REJECTED' || selectedNotification.type === 'CONTRACT_CANCELLED' || selectedNotification.type === 'CONTRACT_EXPIRED') && (
                  <div className="modal-contract-cta" style={{ background: 'rgba(239, 68, 68, 0.1)', borderColor: 'rgba(239, 68, 68, 0.3)' }}>
                    <AlertTriangle size={20} style={{ color: '#ef4444' }} />
                    <span>Hợp đồng không còn hiệu lực. Bạn có thể liên hệ bên kia để tạo hợp đồng mới.</span>
                  </div>
                )}

                {/* Action Button */}
                <div className="modal-actions">
                  <button className="modal-btn" onClick={handleModalAction} style={{
